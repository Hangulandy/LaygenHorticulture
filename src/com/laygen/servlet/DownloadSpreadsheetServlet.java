...
public class DownloadSpreadsheetServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		synchronized (lock) {
			...
			if (machine != null && machine.getSelectedSensor() != null
					&& machine.getSelectedSensor().getReadings() != null) {
				Workbook workbook = new HSSFWorkbook();
				Sheet sheet = workbook.createSheet(machine.getSelectedSensor().getName());
